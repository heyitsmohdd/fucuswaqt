                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-3 py-2 bg-white/8 border border-white/12 rounded-xl text-sm text-white placeholder:text-white/30 focus:outline-none focus:ring-1 focus:ring-white/25 focus:border-white/25 transition-all"
                                    />
                                    <button
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="space-y-1.5 max-h-56 overflow-y-auto pr-1">
                                    {quotes.map((quote, index) => (
                                        <div
                                            key={index}
                                            className="flex items-start gap-2 p-3 bg-white/4 rounded-xl border border-white/8 hover:bg-white/8 transition-colors group"
                                        >
