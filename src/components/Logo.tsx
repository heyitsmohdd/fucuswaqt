    ...
    <>
      <style>{`
        ...
        @keyframes clover-glow {
          0%, 100% { filter: drop-shadow(0 0 2px rgba(192,132,252,0.3)); }
          50%       { filter: drop-shadow(0 0 8px rgba(192,132,252,0.75)); }
        }
      ...
      >
        <div className="logo-outer">
          <div className="clover-spin">
            ...
            >
              <circle className="p1" cx="16" cy="9"  r="8" fill="#C084FC" />
              <circle className="p2" cx="23" cy="16" r="8" fill="#C084FC" />
              <circle className="p3" cx="16" cy="23" r="8" fill="#C084FC" />
              <circle className="p4" cx="9"  cy="16" r="8" fill="#C084FC" />
