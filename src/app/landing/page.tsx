...
import { LogIn, Play, Sparkles, Menu, X } from 'lucide-react';
    ...
    <section className="relative w-full min-h-screen sm:h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center pt-24 sm:pt-28 md:pt-32 px-4 sm:px-6">
        ...
        <p className="mt-6 sm:mt-8 text-[#4b5b47] text-sm sm:text-base md:text-lg leading-relaxed max-w-md px-2">
          A beautiful Pomodoro timer with streak tracking, ambient soundscapes, and a GitHub-style focus heatmap — built for people who value deep work.
        </p>
      </div>
      ...
      <div className="absolute left-4 right-4 sm:right-auto sm:left-6 md:left-10 bottom-6 sm:bottom-8 md:bottom-10 z-10 max-w-sm">
        <div className="flex items-center gap-2 text-[#3d5638] sm:text-white/95 mb-3">
          ...
          <span className="text-sm font-semibold sm:font-medium">Built for deep work</span>
        </div>
        <p className="text-[#3d5638]/90 sm:text-white/85 text-xs leading-relaxed mb-6 max-w-xs font-medium sm:font-normal">
          FocusWaqt brings together a Pomodoro timer, streak tracking, ambient soundscapes, and a GitHub-style focus heatmap — all in one distraction-free space.
        </p>
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <a href="#how-it-works" className="text-[#3d5638] sm:text-white text-sm font-semibold sm:font-medium hover:opacity-80 transition-opacity">
            See How It Works
          </a>
        </div>
      </div>
